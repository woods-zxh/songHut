...
public class MediaService extends Service {
    ...
    private String[] musicPath = new String[]{
            Environment.getExternalStorageDirectory() + "/pauseRecordDemo/wav/20190627110927.wav",
            Environment.getExternalStorageDirectory() + "/pauseRecordDemo/wav/20190627110927.wav"
    };
    //初始化MediaPlayer
...
//        Log.d("eeeeeeeeeeeeeeeee", fileName);
//
//        musicPath = new String[]{
//                //Environment.getExternalStorageDirectory() + "/pauseRecordDemo/wav/" + fileName +".wav",
//                Environment.getExternalStorageDirectory() + "/pauseRecordDemo/wav/20190627081108.wav",
//        };
