 ...
 * created by 李军邑
 */
public class PlaySingAuditionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_sing_audition);
        //从上个界面接受所录歌曲
    ...
    private void initSeekBar(){
        ...
        //开启SeekBar监听进程
        new Thread(new PlaySingAuditionActivity.SeekBarThread()).start();
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(!postFileToRepositoryBean.getErrorCode().equals("0000")){
                            PlaySingAuditionActivity.this.runOnUiThread(new Runnable() {
                                public void run() {
                            ...
                            PlaySingAuditionActivity.this.runOnUiThread(new Runnable() {
                                public void run() {
                                    ...
                                    Intent intent = new Intent(PlaySingAuditionActivity.this, ShowHutActivity.class);
