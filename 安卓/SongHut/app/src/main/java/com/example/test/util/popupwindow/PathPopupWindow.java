...
public class PathPopupWindow extends PopupWindow {
    ...
    private final int CONST_R = 110; // 圆半径
    private final int CONST_ICON_SIZE = 60;
    ...
    public PathPopupWindow(Context context, List<PathItem> items) {
        this(context, items, Color.WHITE, 15, Color.TRANSPARENT);
    }
    ...
    public static boolean isDimissing = true;
