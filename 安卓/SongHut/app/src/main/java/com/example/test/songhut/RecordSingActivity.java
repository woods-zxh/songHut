 ...
 * created by 李军邑
 */
public class RecordSingActivity extends AppCompatActivity {
    //状态
...
//        audioRecorder = null;
    ...
    private void init() {
        ...
        audioView = (AudioView)findViewById(R.id.audioSing);
        fileName = "";
        chronometerTime = 0;
    }
    ...
    private void initAudioView() {
        ...
        recordManager.setRecordResultListener(new RecordResultListener() {
            ...
            public void onResult(File result) {
                ...
                Intent intent = new Intent(RecordSingActivity.this, PlaySingAuditionActivity.class);
